...
**Example:** You roll a fair dice four times.  What is the probability that you roll:
...
5. You roll not more that 2 on any roll. $(1/3)^4 = `r (1/3)^4`$
6. Even or more than 2.  $1/2 + 1/3 - 1/6 = 2/3$
