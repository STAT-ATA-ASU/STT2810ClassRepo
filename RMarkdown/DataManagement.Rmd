...
Three different approaches to subsetting data will be given.  The first approach is to use the `dplyr` function `filter`, the second approach is to use indices, and the third approach is to use the function `subset`.
