...
* Submit the Literature Review / Citation assignment to [http://www.crowdgrader.org](http://www.crowdgrader.org) no later than 5 pm Friday (Sep 4).  The direct link for this assignment is [http://www.crowdgrader.org/](http://www.crowdgrader.org/)
...
#### Grading Rubric for **Literature Review / Citation Assignment** (PR#1)
...
* Peer reviews for **Literature Review / Citation Assignment** due NLT 11 PM Tuesday.
* **Research Plan Assignment** PDS due NLT 5 PM Friday (Sep 11).  Submit assignment
via [http://www.crowdgrader.org](http://www.crowdgrader.org).  The direct link for the Research Plan Assignment is [http://www.crowdgrader.org/](http://www.crowdgrader.org/)
...
* Revise you Research Plan Assignment as needed 
...
The direct link for the **Data Management Assignment** is [http://www.crowdgrader.org/](http://www.crowdgrader.org/).  

#### Grading Rubric for **Data Management Assignment** (PR#3)

1. Does the *.html file include three categorical variables? 0/1

2. Is there a barplot for each categorical variable with appropriate labels and R code? 0/1

3. Are original variables recoded to readable names and numeric values recoded appropriately? 0/1


* Push your "Research Proposal" to your private repository NLT 5 PM Friday (Sep 27) and resulting `*.html` files.
...
* **ANOVA assignment** due NLT 5 PM Friday (Oct 23).  Submit assignment
via [http://www.crowdgrader.org](http://www.crowdgrader.org).  The direct link for the Analysis of Variance Assignment is (http://www.crowdgrader.org/)
...
* Work on **Correlation assignment** 
* **Correlation assignment** due NLT 5 PM Friday (Nov 6).  Submit assignment
...
* **Regression Assignment** due NLT 5 PM Friday (put acutal date here).  Submit assignment
via [http://www.crowdgrader.org](http://www.crowdgrader.org).  The direct link for the Research Plan Assignment is (http://www.crowdgrader.org/)

**Regression Assignment** 

This is a continuation of the material submitted for the **Correlation** submitted in week13.  You should revise your assignment as needed based on peer comments.  I encourage everyone to make an appointment with the writing center and to have the writing center review your current assignment.
...
* Present your poster (Dec 3....reserve room in Student Union).
* Celebrate!
