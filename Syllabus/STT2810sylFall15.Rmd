...
* Kyra Patel --- Math Lab (Walker Hall 105) Wed 5:45-6:45
...
The course will rely primarily on the text [_Passion Driven Statistics (Light Weight)_](https://github.com/alanarnholt/PDS-Book) also available on [Rpubs](http://rpubs.com/arnholt/126376). Students may find the excellent text [_Reproducible Research with R and RStudio, Second Edition_](http://christophergandrud.github.io/RepResR-RStudio/) by Christopher Gandrud helpful.
